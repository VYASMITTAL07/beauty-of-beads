          ...
          <div className="flex flex-col gap-3">
            {orders.map((o) => (
              <button
                ...
                className="flex items-center justify-between rounded-sm border border-border px-4 py-3 text-left transition-colors hover:border-olive-500"
              >
                <div>
                ...
                <div className="flex items-center gap-3">
                  <span className="rounded-full bg-olive-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-olive-600">
                    {stageLabel(o.status)}
                  </span>
...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="flex items-center justify-end gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                title={user ? `${user.name} — click to log out` : "Log in"}
      ...
      <section id="reviews" className="relative overflow-hidden bg-olive-400 pb-4 pt-6">
        ...
        <button
          ...
          onClick={() => setReviewActive((i) => (i + 1) % REVIEWS.length)}
    ...
    />
    <OrdersView open={ordersViewOpen} onClose={() => setOrdersViewOpen(false)} initialOrderNumber={trackOrderNumber} currency={currency} />
