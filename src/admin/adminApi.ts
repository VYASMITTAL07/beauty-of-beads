...
export type HomepageImageSlot = "hero" | "heritageBanner" | "shopAllTile" | "videos" | "storeVisitBanner";
...
export const adminApi = {
  ...
  products: {
    ...
    // Every admin image upload goes through here — product photos, category
